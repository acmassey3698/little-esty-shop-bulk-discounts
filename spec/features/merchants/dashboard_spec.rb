...
describe 'merchant dashboard page' do
  before(:each) do
    ...
    InvoiceItem.create(item: @item1, invoice: @invoice6, quantity: 1, unit_price: 100)
    InvoiceItem.create(item: @item4, invoice: @invoice7, quantity: 1, unit_price: 100)
    InvoiceItem.create(item: @item4, invoice: @invoice8, quantity: 1, unit_price: 100)
  ...
  it 'has a link to take me to my bulk discounts index' do
